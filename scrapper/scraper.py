...
def write_to_file(country_code, country_data):
    ...
    if not os.path.exists('venv/output/US_videos.csv'):
        os.makedirs('venv/output/US_videos.csv')

    with open(f"{'venv/output/US_videos.csv'}/{country_code}_videos.csv", "w+", encoding='utf-8') as file:
